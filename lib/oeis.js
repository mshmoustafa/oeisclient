...
class OEIS {
    ...
    searchByID(id, format, callback) {
        ...
        let URL = this.endpoint + "search?" + "language=" + this.language + "&" + "q=" + "id:" + id + "&" + "fmt=" + format;
    ...
    searchByTermsAndStart(terms, start, format, callback) {
        ...
        let URL = this.endpoint + "search?" + "language=" + this.language + "&" + "q=" + terms.toString() + "&" + "fmt=" + format + "&" + "start=" + start;
        this.doRequest(URL, format, callback);
    }
    /**
