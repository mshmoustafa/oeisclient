...
class OEIS {
     ...
     * @param useHTTPS true = requests should be sent over HTTPS. Using HTTPS might not work with the proxy.
     */
    constructor(language, useProxy, useHTTPS) {
        /**
        ...
        this.endpoint = this.proxy + this.protocol + "oeis.org/";
        this.language = language;
    }
    /**
     * Convenience method that builds a URL for an OEIS query with a language, id, and format.
     * @param {string} language Optional. The language of the search results. Example: english
     * @param {string} id Required. The ID to search for.
     * @param {string} format Optional but highly recommended. The format of the returned search results. Can be "json" or "text".
    ...
    /**
     * Convenience method that builds a URL for an OEIS query with a language, search terms, format, and start.
     * @param {string} language Optional. The language of the search results. Example: english
     * @param {[string]} terms Required. The terms to search for.
     * @param {string} format Optional but highly recommended. The format of the returned search results. Can be "json" or "text".
     * @param {number} start Optional. OEIS returns at most 10 results at a time, so start is used to adjust which results are retrieved. Example: start=0 gets the first 10 search results, start=10 will get the next 10 search results, etc. Defaults to 0.
     * @return {string} The URL.
     */
    ...
    /**
     * Convenience method that builds a URL for a sequence's graph.
     * @param {string} id
     * @return {string}
     */
    getURLForGraph(id) {
     ...
     * @param {string} id A string containing the ID of the sequence. Example: "A000045".
     * @param {string} format "png"
     * @param callback a function that is called with the data passed as an argument. The argument is returned as data since the format is PNG.
     */
    ...
    /**
     * Convenience method that builds a URL for a sequence's list.
     * @param {string} id
     * @return {string}
     */
    getURLForList(id) {
    ...
    /**
     * Convenience method that builds a URL for a sequence's refs.
     * @param {string} id
     * @return {string}
     */
    getURLForRefs(id) {
    ...
    /**
     * Convenience method that builds a URL for a sequence's listen page.
     * @param {string} id
     * @return {string}
     */
    getURLForListen(id) {
    ...
    /**
     * Convenience method that builds a URL for a sequence's history.
     * @param {string} id
     * @return {string}
     */
    getURLForHistory(id) {
    ...
    /**
     * Convenience method that builds a URL for a sequence's text page.
     * @param {string} id
     * @return {string}
     */
    getURLForText(id) {
    ...
    /**
     * Convenience method that builds a URL for a sequence's internal format page.
     * @param {string} id
     * @return {string}
     */
